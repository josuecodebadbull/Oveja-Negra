    ...
    $(document).ready(function() {
      $('body').stellar();
       ...
       $('#titulo').click(function(e) {  
          $.fancybox.open([
          {
            href : 'images/filij32/2.jpg',
            title : 'F I L I J  3 2'
          }, {
            href : 'images/filij32/1.jpg'
          }, {
            href : 'images/filij32/3.jpg'
          }, {
            href : 'images/filij32/4.jpg'
          }, {
            href : 'images/filij32/5.jpg'
          }, {
            href : 'images/filij32/6.jpg'
          }, {
            href : 'images/filij32/7.jpg'
          }
        ], {
          helpers : {
            thumbs : {
   ...
   <div  class="caja total bnegro" >    
    <div id="" class="grupo">  
      ...
      <div id="titulo" class="caja total borde blanco ">
        <p  class="ti birdman blanco  txtcenter">Filij32</p> <br>
        <div class="caja total txtleft">
               ...
               <script src="js/jquery.backstretch.js"></script>
                  <script>
                      $("#pics").backstretch([
                         ...
                         "images/filij32/2portada.jpg",
                         "images/filij32/3portada.jpg",
                         
                         
                         "images/filij32/6portada.jpg"
          ...
          <div class="caja movil-100 tablet-100 web-100  pad-30 ">
            <div id="video" class="caja-total txtcenter ">
               ...
               <iframe width="70%" height="100%" src="https://www.youtube.com/embed/we_5zLMfy_g" frameborder="0" allowfullscreen></iframe>
            </div>
          ...
          <div id="logograndeAlicia" class="caja movil-100 tablet-100 web-100 pad-30 " data-stellar-background-ratio="0.5">
                  <div class="caja movil-100 centrar-contenido tablet-50 web-50 ">
                        ...
                        <p class="parra  blanco  txtjustify ">
                         El principal objetivo de la FILIJ es fomentar el hábito de la lectura entre la población infantil y juvenil de México; así como congregar a editores, libreros, distribuidores, bibliotecarios, maestros y especialistas, con el fin de elevar la calidad y cantidad de publicaciones que circulan en el mercado mexicano.<br><br> Además, de promover el intercambio con otros países y acercar al público a las ediciones nacionales e internacionales.
