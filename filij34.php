  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#titulo').click(function(e) {  
          $.fancybox.open([
          {
            href : 'images/filij34/1.jpg',
            title : 'F I L I J  3 4'
          }, {
            href : 'images/filij34/2.jpg'
          }, {
            href : 'images/filij34/3.jpg'
          }, {
            href : 'images/filij34/4.jpg'
          }, {
            href : 'images/filij34/5.jpg'
          }, {
            href : 'images/filij34/6.jpg'
          }, {
            href : 'images/filij34/7.jpg'
          }, {
            href : 'images/filij34/8.jpg'
          }
        ], {
          helpers : {
            thumbs : {
   ...
   <div  class="caja total bnegro" >    
    <div id="" class="grupo">  
      ...
      <div id="titulo" class="caja total borde blanco ">
        <p  class="ti birdman blanco  txtcenter">Filij 34</p> <br>
                ...
                <script src="js/jquery.backstretch.js"></script>
                  <script>
                      $("#pics").backstretch([
                         ...
                         "images/filij34/1portada.jpg",
                         "images/filij34/2portada.jpg",
                         "images/filij34/3portada.jpg",
                         "images/filij34/4portada.jpg",
                         "images/filij34/5portada.jpg",
                         "images/filij34/6portada.jpg"
          ...
          <div id="logograndeAlicia" class="caja movil-100 tablet-100 web-100 pad-30 " data-stellar-background-ratio="0.5">
                  ...
                  <div class="caja movil-100 tablet-50 web-50    arriba">
                    ...
                    <div class="logo txtcenter">
                      <img  src="images/filij34cartel.jpeg" >
                    </div>
