    ...
    <script type="text/javascript">
            ...
            function initMap() {
              ...
              var map = new google.maps.Map(document.getElementById('map'), {
                ...
                place: {
                  location: {lat: -19.437569, lng:  -99.153578},
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $("#estramboticos").backstretch("images/estramboticos.jpg");
        ...
        $("#porter").backstretch("images/porter2.jpg");
        });
...
C.P. 06030, México D.F.
   ...
   <div class="caja total abajo">
   <p class="ti quien altoti"> Ubicación</p>
        <iframe width="600" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/search?q=Ignacio%20Mariscal%20%23120.%20%20Col.Tabacalera%2C%20%20C.P.%2006030%2C%20M%C3%A9xico%20D.F.&key=AIzaSyC6KIr6reeNd54jetJhjP_mp_PBVZ8Qg7E" allowfullscreen></iframe>
  </div>
