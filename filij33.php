    ...
    $(document).ready(function() {
      $('body').stellar();
       ...
       $('#titulo').click(function(e) {  
          $.fancybox.open([
          {
            href : 'images/filij33/1.jpg',
            title : 'F I L I J  3 3'
          }, {
            href : 'images/filij33/2.jpg'
          }, {
            href : 'images/filij33/3.jpg'
          }, {
            href : 'images/filij33/4.jpg'
          }, {
            href : 'images/filij33/5.jpg'
          }, {
            href : 'images/filij33/6.jpg'
          }, {
            href : 'images/filij33/7.jpg'
          }, {
            href : 'images/filij33/8.jpg'
          }, {
            href : 'images/filij33/9.jpg'
          }
        ], {
          helpers : {
            thumbs : {
   ...
   <div  class="caja total bnegro" >    
    <div id="" class="grupo">  
      ...
      <div id="titulo" class="caja total borde blanco ">
        <p  class="ti birdman blanco  txtcenter">Filij 33</p> <br>
               ...
               <script src="js/jquery.backstretch.js"></script>
                  <script>
                      $("#pics").backstretch([
                         ...
                         "images/filij33/1portada.jpg",
                         "images/filij33/2portada.jpg",
                         "images/filij33/3portada.jpg",
                         "images/filij33/4portada.jpg",
                         "images/filij33/5portada.jpg"
