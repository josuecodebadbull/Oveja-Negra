...
<!-- Add fancyBox main JS and CSS files -->
  ...
  <script type="text/javascript">
    ...
    $('#titulo').click(function(e) {  
          $.fancybox.open([
          {
            href : 'images/enjambre/1.jpg',
            title : 'ENJAMBRE'
          }, {
            href : 'images/enjambre/2.jpg'
          }, {
            href : 'images/enjambre/3.jpg'
          }, {
            href : 'images/enjambre/4.jpg'
          }, {
            href : 'images/enjambre/5.jpg'
          }
        ], {
          helpers : {
            thumbs : {
...
<body style="background-color: black">
   ...
   <div  class="caja total bnegro" >    
    <div id="" class="grupo">  
      ...
      <div id="titulo" class="caja total borde blanco ">
        <p  class="ti birdman blanco  txtcenter">Enjambre</p> <br>
        <div class="caja total txtleft">
          <a id="titulo"  class="rotate"><img src="img/gallery.png" width="40" height="40"/></a>
               ...
               <script src="js/jquery.backstretch.js"></script>
                  <script>
                      $("#pics").backstretch([
                        "images/enjambre/1portada.jpg",
                         "images/enjambre/2portada.jpg",
                         "images/enjambre/3portada.jpg",
                         "images/enjambre/4portada.jpg"
          ...
          <div class="caja movil-100 tablet-100 web-100  pad-30 ">
            <div id="video" class="caja-total txtcenter ">
               ...
               <iframe  width="70%" height="100%" src="https://www.youtube.com/embed/kA2C2DGVnWY" frameborder="0" allowfullscreen></iframe>
            </div>
          ...
          <div id="logograndeEnjambre" class="caja movil-100 tablet-100 web-100 pad-30 " data-stellar-background-ratio="0.5">
                  <div class="caja movil-100 centrar-contenido tablet-50 web-50 ">
                                            
                        <p class="parra arriba abajo  blanco pad-30 txtjustify ">
                      “Con un sonido nostálgico y pleno en guiños al rock clásico, Enjambre rebasa el ámbito del indie, para ubicarse con fuerza dentro del mainstream musical”.<br><br>
                        </p>
                        <h3>-Vicente Jáuregui, acerca de -Enjambre:<br> Trae su nostalgia clásica, al Ruido Fest!<br> - LABANDAELÁSTICA.COM, 2015-</h3>
                        <div class="caja total arriba centrar-contenido">
                        <img src="images/enjambre/logo.png" width="200">
                      </div>  
  ...
  <div class="caja movil-1-3 txtcenter pad-10"><h3>Cámara de faltas</h3></div>
  <div class="caja movil-2-3  txtcenter pad-10">  <audio id="medio" controls>
                              <source src="audio/enjambre/camara.mp3" type="audio/mp3">
                              Your browser does not support the audio element.
                            </audio></div>
                            </div>
                             <div class="grupo movil-tabla">
  <div class="caja movil-1-3 txtcenter pad-10"><h3>Elemento</h3></div>
  <div class="caja movil-2-3  txtcenter pad-10">  <audio controls>
                              <source src="audio/enjambre/elemento.mp3" type="audio/mp3">                    
                              Your browser does not support the audio element.
                            </audio></div>
                            </div>
                             <div class="grupo movil-tabla">
  <div class="caja movil-1-3 txtcenter pad-10"><h3>Sábado Perpetuo</h3></div>
  <div class="caja movil-2-3  txtcenter pad-10"> <audio controls>
                              <source src="audio/enjambre/sabado.mp3" type="audio/mp3">                    
                              Your browser does not support the audio element.
                            </audio></div>
                            </div>
                ...
                <div class="caja total  pad-30 ">
                      <div class="caja movil-50 centrar-contenido  ">
                        <a href="https://www.facebook.com/enjambre?fref=ts " target="_blank">
                      ...
                      <div class="caja movil-50   ">
                        <a href=" https://twitter.com/enjambremx?lang=es" target="_blank">
