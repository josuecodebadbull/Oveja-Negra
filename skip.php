		...
		<div id="" class="grupo">  
			...
			?>
				<div id="titulo" class="caja total borde blanco ">
					<p  class="ti birdman blanco  txtcenter">SKIP & DIE</p>
						...
						<div class="grupo movil-tabla">
							<div class="grupo movil-tabla">
								<div class="caja movil-1-3 txtcenter">
									<h3>LA cumbia dictadura</h3>
								</div>
								<div class="caja movil-2-3  txtcenter pad-10">
									<audio id="medio" controls>
										<source src="audio/skip/cumbia.mp3" type="audio/mp3">
								...
								<div class="grupo movil-tabla">
									...
									<div class="caja movil-2-3  txtcenter pad-10">
										<audio controls>
											<source src="audio/skip/jihad.mp3" type="audio/mp3"> 
												Your browser does not support the audio element.
											</audio>
										</div>
									</div>
									...
									<div class="grupo movil-tabla">
										<div class="caja movil-1-3 txtcenter"><h3>Señorita</h3></div>
										<div class="caja movil-2-3  txtcenter pad-10">
											<audio controls>
												<source src="audio/skip/señorita.mp3" type="audio/mp3">   Your browser does not support the audio element.
												</audio>
											</div>
										</div>
								...
								<div class="caja total pad-30 ">
									<div class="caja movil-25   ">
										<a href="https://www.facebook.com/skipndie/?fref=ts" target="_blank">
											<div class="facebook centrar-contenido">
											</div>
										</a>
									</div>
									<div class="caja movil-25   ">
										<a href="https://twitter.com/SKIPnDIE" target="_blank">
											<div class="twitter centrar-contenido">
											</div>
										</a>
									</div>
									<div class="caja movil-25  ">
										<a href="https://www.instagram.com/skipndie/" target="_blank">
										<div class="instagram centrar-contenido">
										</div>
									</a>
								</div>
								<div class="caja movil-25  ">
									<a href="https://www.youtube.com/user/SKIPnDIEVEVO" target="_blank">
