...
<link rel="icon" href="img/logooveja.ico">
...
<div id="infoperson" class="caja total  ">
    <div  class="grupo">
        ...
        <div class="caja movil-100 tablet-50 web-50  txtcenter">
            <p class="ti quien  altoti txtcenter">Community Management</p>
            <p class="parra quienes txtcenter">
                Jose Darío Arias Roldán<br>
            <a class="parra quienes txtcenter" href="mailto:dario@agenciaovejanegra.com?subject=Contrataciones de servicios de producción y/o booking en México o USA&body=Estoy interesado en contratar (servicios de producción o talento) para mi venue, evento especial y/o Festival en USA (o México), y escribo para… Saludos?subject=Contrataciones de servicios de producción y/o booking en México o USA" >dario@agenciaovejanegra.com </a> <br>
            </p> 
        </div>
    </div>
    <div class="grupo espace">
    </div>
    ...
    <div class="grupo">
        <div id="mapaweb" class="caja total alto abajo  ">
          ...
          <script type="text/javascript" src="http://www.webestools.com/google_map_gen.js?lati=19.437969&long=-99.153978&zoom=17&width=767&height=400&mapType=normal&map_btn_normal=yes&map_btn_satelite=yes&map_btn_mixte=yes&map_small=yes&marqueur=yes&info_bulle="></script>
          </div>
        </div>
        ...
        <div id="mapamobile" class="caja movil-100 ">
    ...
    <div id="GruposB" class="caja total display">
      ...
      <div class="caja movil-100 tablet-100 web-100" style="padding-top:120px !important;">
        <div class="cerrar tache"><a id="closemenub" class="rotate">  <img src="img/closen.png" width="80" height="80"/></a></div>
          ...
          <div id="" class="caja movil-100 tablet-50 web-50  alto">
          <a href="technicolor.php"><div id="tech" class="caja total "></div> </a>
          <div class="caja total">
            <p class="ti quien altoti">Technicolor Fabrics</p>
          </div>  
          </div>
          <div id="" class="caja movil-100 tablet-50 web-50  alto">
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
      ...
      <div class="caja movil-100 tablet-100 web-50 pad-30">
        <div class="grupo  centrar-contenido ">
          ...
          <div class="caja movil-50 tablet-1-3 altototal2 ">
          ...
          <div class="caja movil-50 tablet-50 altototal2">
            <a id="" href="tel:70335699" class="rotate ">  <img src="images/tel.png" width="100"/></a>
          </div>
          <div class="caja movil-100 tablet-50 altototal2">
          ...
          <div class="caja movil-100 altototal2">
            <p class="parra quienes">
              ...
              Alejandra Diaz.- 33 3370 8363<br>
            </p>
          </div>
        </div>
      </div>
      <div id="reservado" class="caja total pad-30">
        <div class="grupo">
          ...
          <div class="caja caja movil-100  tablet-1-3  centrar-contenido ">
