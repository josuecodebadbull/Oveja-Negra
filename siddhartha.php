  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#titulo').click(function(e) {  
          $.fancybox.open([
           {
            href : 'images/sidd/IMG_8218.jpg'
          }, {
            href : 'images/sidd/sid2_zps90a3e51e.jpg'
          }, {
            href : 'images/sidd/sidd1_zps8c6942cc.jpg'
          },{
          	href : 'images/sidd/sidd36_zps98890b13-1.jpg'
          }
        ], {
          helpers : {
            thumbs : {
   ...
   <div  class="caja total bnegro" >    
    <div id="" class="grupo">  
      ...
      <div id="titulo" class="caja total borde blanco ">
        <p  class="ti birdman blanco  txtcenter">SIDDHARTHA</p> <br>
         ...
         <script src="js/jquery.backstretch.js"></script>
                  <script>
                      $("#pics").backstretch([
                         ...
                         "images/sidd/3portada.jpg",
                         "images/sidd/4portada.jpg",
                        
                         "images/sidd/sidd36_zps98890b13-1.jpg"
          ...
          <div class="caja movil-100 tablet-100 web-100  pad-30 ">
            <div id="video" class="caja-total txtcenter ">
				<iframe width="70%" height="100%" src="https://www.youtube.com/embed/Rux-Q_nPrp0" frameborder="0" allowfullscreen></iframe>
            </div>
          </div>
          <div id="logosidd" class="caja movil-100 tablet-100 web-100 pad-30 " data-stellar-background-ratio="1.2">
                  <div class="caja movil-100 centrar-contenido tablet-50 web-50 ">
                                            
                        <p class="parra arriba abajo  blanco pad-30 txtjustify ">
                        “ Consigue una nominación al Latin Grammy 2008 por - Mejor Album de Rock Vocal - al lado de Andrés Calamaro, Chetes, Juanes, Loquillo y Alih Jey. “<br><br>
                        </p>
                        <h3>-acerca de -SIDDHARTHA NOMINADO AL GRAMMY LATINO- Grita Radio-</h3>
                        <div class="caja total arriba centrar-contenido">
                        <img src="images/sidd/siddhartha_logo.png" width="200">
                      </div>  
                  ...
                  <div  id="playlist" class="caja movil-100 tablet-50 web-50 pad-30">
                    ...
                    <div class="grupo movil-tabla">
                             ...
                             <div class="grupo movil-tabla">
                              <div class="caja movil-1-3 txtcenter pad-10"><h3>Náufrago</h3></div>
                              <div class="caja movil-2-3  txtcenter pad-10">
                               <audio id="medio" controls>
                              <source src="audio/sidd/Naufrago.mp3" type="audio/mp3">
                            ...
                            <div class="grupo movil-tabla">
                              <div class="caja movil-1-3 txtcenter pad-10"><h3>Domingo</h3></div>
                              <div class="caja movil-2-3  txtcenter pad-10">
                              <audio controls>
                              <source src="audio/sidd/Domingo.mp3" type="audio/mp3">                    
                              Your browser does not support the audio element.
                            </audio>
                              </div>
                            </div>
                            ...
                            <div class="grupo movil-tabla">
                              <div class="caja movil-1-3 txtcenter pad-10"><h3>El Poema y la Caja</h3></div>
                              <div class="caja movil-2-3  txtcenter pad-10">
                              <audio controls>
                              <source src="audio/sidd/El Poema y la Caja.mp3" type="audio/mp3">                    
                              Your browser does not support the audio element.
                            </audio>
                              </div>
                            </div>
